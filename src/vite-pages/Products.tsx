          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="space-y-3">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-lg font-medium">
                Manage your product listings with real-time inventory and pricing controls
              </p>
            </div>
            <div className="flex items-center gap-3">
              <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl p-4 border border-emerald-200/50 dark:border-emerald-800/50">
                <div className="text-center">
                  ...
                  <div className="text-sm text-slate-600 dark:text-slate-300 font-medium">Products</div>
                </div>
              </div>
            </div>
          </div>
